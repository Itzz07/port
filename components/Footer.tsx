        ...
        <div className="max-w-6xl mx-auto space-y-16 px-6 py-16 text-gray-600 2xl:px-0">
            <div className="flex flex-wrap items-center justify-between gap-4 border-b border-t py-8 border-[--ui-light-border-color] dark:border-[--ui-dark-border-color]">
                ...
                <div className="flex gap-3">
                    ...
                    <Link href="https://www.linkedin.com/in/joel-zimba-5325a8293/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="size-8 flex *:m-auto rounded-[--btn-border-radius]  text-gray-600 dark:text-gray-400 hover:text-orange-600 dark:hover:text-orange-500 hover:shadow-orange-600 shadow-md">
                    ...
                    <Link href="https://www.instagram.com/in/zimbajoel1" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="size-8 flex *:m-auto rounded-[--btn-border-radius]  text-gray-600 dark:text-gray-400 hover:text-orange-600 dark:hover:text-orange-500 hover:shadow-orange-600 shadow-md">
                        <svg xmlns="http://www.w3.org/2000/svg" className="size-5" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <Link href="mailto:zimbajoel1@gmail.com" aria-label="Email" className="size-8 flex *:m-auto rounded-[--btn-border-radius] text-gray-600 dark:text-gray-400 hover:text-orange-600 dark:hover:text-orange-500  hover:shadow-orange-600 shadow-md">
                        <svg xmlns="http://www.w3.org/2000/svg" className="size-6" viewBox="0 0 48 48" fill="currentColor">
                        <path 
